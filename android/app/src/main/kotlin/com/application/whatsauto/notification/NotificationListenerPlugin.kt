 ...
 */
class NotificationListenerPlugin private constructor(private val context: Context) : StreamHandler {
    ...
    internal inner class NotificationReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            val packageMessage =
                intent.getStringExtra(NotificationListener.NOTIFICATION_PACKAGE_MESSAGE)
            val packageText = intent.getStringExtra(NotificationListener.NOTIFICATION_PACKAGE_TEXT)
            val packageExtra =
                intent.getStringExtra(NotificationListener.NOTIFICATION_PACKAGE_EXTRA)
    ...
    companion object {
        ...
        fun registerWith(@NonNull flutterEngine: FlutterEngine, context: Context) {
            ...
            val plugin = NotificationListenerPlugin(context)
